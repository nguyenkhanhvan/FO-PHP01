...
<?php 
    ...
    $conn = new mysqli("localhost","root"," ","blog");
    //câu lệnh truy vấn
    $query_post = "SELECT * FROM `posts`ORDER BY created DESC LIMIT 7,1;";
    //câu lệnh thực thi
...
<?php 
    ...
    $conn = new mysqli("localhost","root"," ","blog");
    //câu lệnh truy vấn
    $query_post1 = "SELECT * FROM `posts`ORDER BY created DESC LIMIT 8,6;";
    //câu lệnh thực thi
    $result = $conn->query($query_post1);
    // tạo mảng chứa cơ sở dữ liệu
    $query_post1 = array();
    while($row = $result ->fetch_assoc()) {
        $query_post1 = $row;
